...
export default function NotFound() {
  return (
    <section className="bg-paper pb-(--section-y) pt-[calc(4.75rem+var(--gap))] sm:pt-[calc(5.5rem+var(--gap))]">
      <Shell>
        <div className="rounded-(--radius-shell) bg-surface-alt px-6 py-20 text-center sm:px-8 lg:py-28">
          <p className="font-display text-[6rem] font-extrabold leading-none text-brand lg:text-[9rem]">
            404
          </p>
