...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.info(`[retention] expired bookings cleared: ${result.expired}, orphan uploads removed: ${result.orphans}, orphan vehicle media removed: ${result.media}, staged files cleared: ${result.staged}`);
