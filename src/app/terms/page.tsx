...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Each rental includes a free kilometre allowance, pooled across the whole rental period and published on the vehicle page. Kilometres beyond the allowance are charged at the published per-kilometre rate.",
