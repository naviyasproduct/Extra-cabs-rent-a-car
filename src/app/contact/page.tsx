...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Call, message or visit Extra Cabs & Rent a Cars. Branches in Dehiwala, Negombo, Kandy and at Bandaranaike International Airport.",
};
        ...
        aside={
          <div className="rounded-(--radius-card) bg-ink p-6 text-white">
            ...
            <a
              ...
              className="mt-5 inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-white font-semibold text-ink transition-colors hover:bg-surface-alt"
            >
        ...
        <Shell>
          <Grid>
            {channels.map((channel) => (
              ...
              >
                <span className="grid size-12 place-items-center rounded-(--radius-inner) bg-brand-tint text-brand transition-colors group-hover:bg-brand group-hover:text-white">
            ...
            {locations.map((location) => (
              ...
              >
                ...
                <a
                  ...
                  className="mt-1 inline-block font-display font-semibold transition-colors hover:text-brand"
                >
                  {location.phone}
                </a>
              </div>
